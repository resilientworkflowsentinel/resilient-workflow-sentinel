        ...
        with ui.row().classes('w-full px-6 items-end justify-between gap-6'):
            ...
            with ui.column().classes('flex-grow justify-end items-center pb-1'):
                with ui.row().classes('items-center gap-1'):
                    ...
                    ui.link('Visit here', 'https://resilientworkflowsentinel.github.io/resilient-workflow-sentinel/', new_tab=True).classes('text-blue-400 text-sm underline')
            ...
            with ui.column().classes('items-end gap-2'):
                ...
                with ui.row().classes('items-center gap-4'):
                    ...
                    with ui.row().classes('items-center gap-2'):
                        ...
                        ui.link('GitHub', 'https://github.com/resilientworkflowsentinel/resilient-workflow-sentinel.git', new_tab=True).classes('text-white text-sm font-semibold')
